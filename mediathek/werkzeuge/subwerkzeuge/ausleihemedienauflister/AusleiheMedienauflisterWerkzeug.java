...
public class AusleiheMedienauflisterWerkzeug extends ObservableSubWerkzeug {
	 ...
	 */
	public AusleiheMedienauflisterWerkzeug(MedienbestandService medienbestand, VerleihService verleihService) {
    ...
    private void setzeAnzuzeigendeMedien()
    {
        ...
        for (Medium medium : medienListe)
        {
            ...
            {
                ersterVormerker = _verleihService.getVormerkkarte(medium).getErstenVormerker();
            }
